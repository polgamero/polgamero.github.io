...
ok((version.includes("ENGINE_VERSION = '23.19.2'") || version.includes("ENGINE_VERSION = '23.21.6'")), 'engine 23.17.5.7');
ok(manifest.engineVersion === '23.21.6', 'manifest 23.17.5.7');
ok(manifest.firestoreRulesVersion === '23.13.87', 'rules unchanged');
