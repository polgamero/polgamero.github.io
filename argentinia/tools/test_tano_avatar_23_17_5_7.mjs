...
ok((version.includes("ENGINE_VERSION = '23.19.2'") || version.includes("ENGINE_VERSION = '23.19.4.1'")), 'engine 23.17.5.7');
ok(manifest.engineVersion === '23.19.4.1', 'manifest 23.17.5.7');
ok(manifest.firestoreRulesVersion === '23.13.78', 'rules unchanged');
...
console.log('TANO_AVATAR_23_17_5_7_OK path=assets/images/ui/tano.png size=2.4rem reactiveStack=medium+hard rules=23.13.78');
