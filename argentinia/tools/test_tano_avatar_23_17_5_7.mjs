...
ok((version.includes("ENGINE_VERSION = '23.19.2'") || version.includes("ENGINE_VERSION = '23.19.5.2'")), 'engine 23.17.5.7');
ok(manifest.engineVersion === '23.19.5.2', 'manifest 23.17.5.7');
