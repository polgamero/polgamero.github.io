...
ok((version.includes("ENGINE_VERSION = '23.19.2'") || version.includes("ENGINE_VERSION = '23.21.0'")), 'engine 23.17.5.7');
ok(manifest.engineVersion === '23.21.0', 'manifest 23.17.5.7');
ok(manifest.firestoreRulesVersion === '23.13.81', 'rules unchanged');
