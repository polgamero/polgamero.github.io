...
assert.equal(ENGINE_VERSION,'23.17.4.2');
assert.equal(FIRESTORE_RULES_VERSION,'23.13.75');
assert.equal(manifest.engineVersion,'23.17.4.2');
...
console.log('DAILY_CLOCK_RUNTIME_HARDENING_23_17_3_4_OK normal=D1+D2+gap clock=singleflight+retry claim=topLevelSeal rules=23.13.75');
