...
if (rules) {
  ...
  assert.ok(rules.includes("'23.13.75'"), 'rewardClock no admite attestation 23.13.75.');
...
console.log('MULTIPLAYER_SYNC_REWARD_RECOVERY_23_17_4_2_OK liveNeutralInit=yes legacyInit=yes settlement=v2-receipt-authority rules=23.13.75');
