...
assert.ok(/^23\.19\.4\.(?:4|[5-9]|[1-9]\d+)$/.test(ENGINE_VERSION) || ENGINE_VERSION === '23.21.2',`23.19.4.4+ cumulative engine expected, got ${ENGINE_VERSION}`);
