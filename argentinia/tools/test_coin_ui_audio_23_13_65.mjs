...
assert.ok((version.includes("ENGINE_VERSION = '23.18.3'") || version.includes("ENGINE_VERSION = '23.19.2'")) || (()=>{ try { if (!(version.includes("ENGINE_VERSION = '23.18.3'") || version.includes("ENGINE_VERSION = '23.19.2'"))) return /ENGINE_VERSION = '23\.(?:13\.\d+|1[4-9]\.\d+|[2-9]\d\.\d+)(?:\.\d+)?'|ENGINE_VERSION = '23\.16\.1(?:\.1)?'|ENGINE_VERSION = '23\.16\.(?:2(?:\.1)?|3(?:\.1)?|4(?:\.1)?|5(?:\.[12])?)'/.test(version); } catch { return false; } })());
