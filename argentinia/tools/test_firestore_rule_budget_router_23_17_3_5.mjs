...
assert.equal(ENGINE_VERSION,'23.17.4');
assert.equal(FIRESTORE_RULES_VERSION,'23.13.72');
assert.equal(manifest.engineVersion,'23.17.4');
...
console.log('FIRESTORE_RULE_BUDGET_ROUTER_23_17_3_5_OK dispatcher=single-branch daily=V6 consistency=compact usersUpdate=single-allow rules=23.13.72');
