...
assert.ok(version.includes("FIRESTORE_RULES_VERSION = '23.13.86'"), 'El contrato de Tienda debe convivir con las Rules actuales.');
...
assert.ok(main.includes('src="./assets/images/ui/emotes.png"'), 'La entrada de Emotes debe usar assets/images/ui/emotes.png.');
