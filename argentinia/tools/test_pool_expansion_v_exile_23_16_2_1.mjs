...
assert.ok(['23.16.2.1','23.16.3','23.16.3.1','23.16.4','23.16.4.1','23.16.5','23.16.5.1','23.16.5.2','23.17.1','23.17.2','23.17.3','23.18.3','23.19','23.19.2','23.21.6'].includes(ENGINE_VERSION));
...
assert.ok(['pool_expansion_v_790','pool_expansion_vi_820','pool_expansion_vii_850','pool_expansion_viii_880','dragons_buenos_aires_900'].includes(CURRENT_POOL_MILESTONE));
