...
assert.match(texts, /Bloqueo cancelado: \{attacker\} tiene Amenaza[\s\S]*Amenaza exige 2 o más bloqueadores/);
...
assert.equal(eternal?.text, 'Siempre que muera una criatura, Adiviná 1.');
