...
need(ENGINE_VERSION === '23.21.0', `engine=${ENGINE_VERSION}`);
...
need(manifest.engineVersion === '23.21.0' && manifest.firestoreRulesVersion === '23.13.81' && manifest.pool === 880, 'build-manifest');
