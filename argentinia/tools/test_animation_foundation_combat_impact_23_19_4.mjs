...
need(ENGINE_VERSION === '23.19.5.6', `engine=${ENGINE_VERSION}`);
need(ENGINE_PROTOCOL_VERSION === 'mp-23.19.2', `protocol=${ENGINE_PROTOCOL_VERSION}`);
need(FIRESTORE_RULES_VERSION === '23.13.80', `rules=${FIRESTORE_RULES_VERSION}`);
...
need(manifest.engineVersion === '23.19.5.6' && manifest.firestoreRulesVersion === '23.13.80' && manifest.pool === 880, 'build-manifest');
