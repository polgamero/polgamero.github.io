...
need(ENGINE_VERSION === '23.19.5.1', `engine=${ENGINE_VERSION}`);
...
need(manifest.engineVersion === '23.19.5.1' && manifest.firestoreRulesVersion === '23.13.79' && manifest.pool === 880, 'build-manifest');
