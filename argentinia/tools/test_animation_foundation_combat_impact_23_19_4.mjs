...
need(ENGINE_VERSION === '23.21.4', `engine=${ENGINE_VERSION}`);
...
need(manifest.engineVersion === '23.21.4' && manifest.firestoreRulesVersion === '23.13.86' && manifest.pool === 880, 'build-manifest');
