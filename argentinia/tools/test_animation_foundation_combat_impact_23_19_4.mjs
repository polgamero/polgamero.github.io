...
need(FIRESTORE_RULES_VERSION === '23.13.83', `rules=${FIRESTORE_RULES_VERSION}`);
...
need(manifest.engineVersion === '23.21.3' && manifest.firestoreRulesVersion === '23.13.83' && manifest.pool === 880, 'build-manifest');
