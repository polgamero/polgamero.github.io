...
need(FIRESTORE_RULES_VERSION === '23.13.88', `rules=${FIRESTORE_RULES_VERSION}`);
...
need(manifest.engineVersion === '23.21.6' && manifest.firestoreRulesVersion === '23.13.88' && manifest.pool === 900, 'build-manifest');
