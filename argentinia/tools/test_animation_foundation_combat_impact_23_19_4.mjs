...
need(ENGINE_VERSION === '23.20.0', `engine=${ENGINE_VERSION}`);
...
need(manifest.engineVersion === '23.20.0' && manifest.firestoreRulesVersion === '23.13.80' && manifest.pool === 880, 'build-manifest');
