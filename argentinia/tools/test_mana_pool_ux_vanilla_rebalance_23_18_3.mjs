...
assert.ok((version.includes("ENGINE_VERSION = '23.19.2'") || version.includes("ENGINE_VERSION = '23.19.5.6'")), 'engine 23.19');
...
console.log(`MANA_POOL_UX_VANILLA_REBALANCE_23_18_3_OK pool=880 vanillaMV2plus=${bad.length} trueVanilla=${allVanilla.length} upgraded=17 rules=23.13.80`);
