...
assert.ok((version.includes("ENGINE_VERSION = '23.19.2'") || version.includes("ENGINE_VERSION = '23.19.4'")), 'engine 23.19');
assert.equal(manifest.engineVersion, '23.19.4');
...
console.log(`MANA_POOL_UX_VANILLA_REBALANCE_23_18_3_OK pool=880 vanillaMV2plus=${bad.length} trueVanilla=${allVanilla.length} upgraded=17 rules=23.13.77`);
