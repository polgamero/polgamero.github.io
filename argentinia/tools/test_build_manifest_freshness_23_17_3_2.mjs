...
assert.equal(ENGINE_VERSION, '23.17.3.2');
...
console.log('BUILD_MANIFEST_FRESHNESS_23_17_3_2_OK engine=23.17.3.2 protocol=canonical+legacy rules=23.13.69 pool=880');
