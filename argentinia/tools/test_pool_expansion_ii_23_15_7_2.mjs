...
if (!(version.includes("ENGINE_VERSION = '23.18.3'") || (version.includes("ENGINE_VERSION = '23.19.2'") || version.includes("ENGINE_VERSION = '23.20.0'")))) assert.match(version,/ENGINE_BASELINE = '[^']*23\.15\.7\.2 POOL EXPANSION II/);
