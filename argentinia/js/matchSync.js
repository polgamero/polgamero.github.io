...
export function serializeStackForPublic(stack, state, myRole) {
  ...
  return stack.map(item => {
    ...
    const wire = {
      ...
      exilePermissionId: item?.exilePermissionId ?? null,
      exilePlayEngineVersion: item?.exilePlayEngineVersion ?? null,
      suspendEngineVersion: item?.suspendEngineVersion ?? null,
      suspendHaste: !!item?.suspendHaste,
      ...
      isCopy: !!item?.isCopy,
      wasCast: item?.wasCast === false ? false : null,
      copyKind: item?.copyKind ?? null,
      copiedFromStackId: item?.copiedFromStackId ?? null,
      copyCreatedBy: item?.copyCreatedBy ?? null,
      copyEngineVersion: item?.copyEngineVersion ?? null,
      sagaChapter: item?.sagaChapter ?? null,
      sagaChapterRoman: item?.sagaChapterRoman ?? null,
      sagaChapterSpecKey: item?.sagaChapterSpecKey ?? null,
      sagaLoreBefore: item?.sagaLoreBefore ?? null,
      sagaLoreAfter: item?.sagaLoreAfter ?? null,
      sagaPendingKey: item?.sagaPendingKey ?? null,
...
export function deserializeStackFromPublic(stackState, state, myRole) {
  ...
  return stackState.map(wire => {
    const item = {
      ...
      exilePermissionId: wire?.exilePermissionId ?? null,
      exilePlayEngineVersion: wire?.exilePlayEngineVersion ?? null,
      suspendEngineVersion: wire?.suspendEngineVersion ?? null,
      suspendHaste: !!wire?.suspendHaste,
      ...
      isCopy: !!wire?.isCopy,
      wasCast: wire?.wasCast === false ? false : null,
      copyKind: wire?.copyKind ?? null,
      copiedFromStackId: wire?.copiedFromStackId ?? null,
      copyCreatedBy: wire?.copyCreatedBy ?? null,
      copyEngineVersion: wire?.copyEngineVersion ?? null,
      sagaChapter: wire?.sagaChapter ?? null,
      sagaChapterRoman: wire?.sagaChapterRoman ?? null,
      sagaChapterSpecKey: wire?.sagaChapterSpecKey ?? null,
      sagaLoreBefore: wire?.sagaLoreBefore ?? null,
      sagaLoreAfter: wire?.sagaLoreAfter ?? null,
      sagaPendingKey: wire?.sagaPendingKey ?? null,
