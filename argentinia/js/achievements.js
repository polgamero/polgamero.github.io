...
export function normalizeAchievementProfile(raw={}){const source=raw&&typeof raw==='object'&&!Array.isArray(raw)?raw:{},claimed=source.claimed&&typeof source.claimed==='object'&&!Array.isArray(source.claimed)?source.claimed:{};return{schemaVersion:1,claimed:{...claimed}};}
