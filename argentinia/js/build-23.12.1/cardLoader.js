...
const DATA_FILES = {
  tierras: `./assets/data/tierras.json?v=${encodeURIComponent(ENGINE_VERSION)}`,
  artefactos: `./assets/data/artefactos.json?v=${encodeURIComponent(ENGINE_VERSION)}`,
  criaturas: `./assets/data/criaturas.json?v=${encodeURIComponent(ENGINE_VERSION)}`,
  instantaneos: `./assets/data/instantaneos.json?v=${encodeURIComponent(ENGINE_VERSION)}`,
  conjuros: `./assets/data/conjuros.json?v=${encodeURIComponent(ENGINE_VERSION)}`,
  encantamientos: `./assets/data/encantamientos.json?v=${encodeURIComponent(ENGINE_VERSION)}`,
  planeswalkers: `./assets/data/planeswalkers.json?v=${encodeURIComponent(ENGINE_VERSION)}`
};
