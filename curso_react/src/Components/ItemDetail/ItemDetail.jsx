    ...
    return(
        <article className="item-article">
            ...
            <footer className="item-footer">
                <div>
                {
                    quantityAdded > 0 ? (<Link to='/cart' className="counter-button" style={{textDecoration: 'none'}}>Ver Carrito</Link>) : (<ItemCount inicial={1} stock={stock} onAdd={handleOnAdd} className="item-count"/>)
                }
                </div>
            </footer>
        </article>
